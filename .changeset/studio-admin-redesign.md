...
"@gemologic/sheen-charts": minor
"@gemologic/sheen-patterns": minor
"@gemologic/sheen-table": minor
"@gemologic/sheen-tokens": minor
---

Refresh Studio and the admin starter with a quieter surface hierarchy, locally bundled Inter Variable, retained IBM Plex Mono identifiers, clearer typography, and responsive metric, chart, table, and form layouts. The admin starter defaults to dark Studio with indigo; the global Obsidian/jade defaults, other themes, private themes, and independent appearance axes remain available.
