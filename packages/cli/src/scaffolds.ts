...
export interface AppScaffoldAssets {
  ...
  readonly solidPatch: string;
  readonly kobalteCorePatch: string;
  readonly kobalteUtilsPatch: string;
}
...
async function bundledAppAssets(): Promise<AppScaffoldAssets> {
  const [skill, context, solidPatch, kobalteCorePatch, kobalteUtilsPatch] = await Promise.all([
    ...
    loadAppAsset("./app-patches/solid-js@1.9.15.patch", "../../../patches/solid-js@1.9.15.patch"),
    loadAppAsset("./app-patches/@kobalte__core@0.13.13.patch", "../../../patches/@kobalte__core@0.13.13.patch"),
    loadAppAsset("./app-patches/@kobalte__utils@0.9.2.patch", "../../../patches/@kobalte__utils@0.9.2.patch"),
  ]);
...
export default defineConfig({
  plugins: [sheenIcons({ sets: ["radix", "phosphor"] }), solidStart({ devOverlay: false }), tailwind()],
});
`),
...
All seven bundled themes and twelve accent presets are imported. Remove unused theme/accent CSS entries when bundle size matters. The generated app carries the currently qualified Solid/Kobalte compatibility patches. Requalify the delayed-hydration regressions before removing or replacing them.
`),
...
`),
    file("patches/solid-js@1.9.15.patch", assets.solidPatch),
    file("patches/@kobalte__core@0.13.13.patch", assets.kobalteCorePatch),
    file("patches/@kobalte__utils@0.9.2.patch", assets.kobalteUtilsPatch),
