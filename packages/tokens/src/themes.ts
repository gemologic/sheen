...
const studioType: Partial<Tokens> = {
  ...
  "text-ui-weight": "510", "text-ui-sm-weight": "510",
  "text-h1-weight": "510", "text-h2-weight": "590", "text-h3-weight": "590", "text-h4-weight": "590",
  "text-stat-weight": "510",
  "text-body-size": "16px", "text-body-leading": "24px",
  "text-caption-size": "12px", "text-caption-leading": "16px",
  "text-ui-size": "14px", "text-ui-leading": "20px",
  "text-h1-size": "20px", "text-h1-leading": "28px",
  "text-h2-size": "18px", "text-h2-leading": "24px",
  "text-h3-size": "16px", "text-h3-leading": "24px",
  "control-radius": "6px", "surface-radius": "12px",
  "elevation-raised": "none",
  "duration-fast": "120ms", "duration-normal": "180ms", "duration-slow": "260ms",
  "ease-standard": "cubic-bezier(0.22, 1, 0.36, 1)",
  "ease-entrance": "cubic-bezier(0.22, 1, 0.36, 1)",
};
export const studio = theme("studio", "Studio", {
  ...studioType,
  "color-bg": "#08090a", "color-bg-subtle": "#0b0c0e", "color-bg-raised": "#101113", "color-bg-inset": "#212226",
  "color-bg-hover": "#191a1b", "color-bg-active": "#212226", "color-bg-selected": "#212226",
  "color-fg": "#f7f8f8", "color-fg-muted": "#969ca6", "color-fg-subtle": "#969ca6",
  "color-border": "#252628", "color-border-control": "#7f858e", "color-border-strong": "#353639", "color-border-subtle": "#1c1d1f",
  "color-focus-ring": "#ffffff",
}, {
  ...studioType,
  "color-bg": "#f7f8f8", "color-bg-subtle": "#ffffff", "color-bg-raised": "#ffffff", "color-bg-inset": "#e7e9ec",
  "color-bg-hover": "#f3f4f5", "color-bg-active": "#e7e9ec", "color-bg-selected": "#e7e9ec",
  "color-fg": "#101113", "color-fg-muted": "#60666f", "color-fg-subtle": "#60666f",
  "color-border": "#e0e1e3", "color-border-control": "#777d86", "color-border-strong": "#d3d4d6", "color-border-subtle": "#eeeff0",
  "color-focus-ring": "#101113",
}, "phosphor");
