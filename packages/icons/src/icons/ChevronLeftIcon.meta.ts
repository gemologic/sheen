...
export default Object.freeze({
  name: "ChevronLeftIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "chevronLeft action", code: "<ChevronLeftIcon decorative={false} label=\"chevronLeft\" />" }],
