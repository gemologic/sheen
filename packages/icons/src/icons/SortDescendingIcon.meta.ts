...
export default Object.freeze({
  name: "SortDescendingIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "sortDescending action", code: "<SortDescendingIcon decorative={false} label=\"sortDescending\" />" }],
