...
export default Object.freeze({
  name: "ArrowRightIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "arrowRight action", code: "<ArrowRightIcon decorative={false} label=\"arrowRight\" />" }],
