...
export default Object.freeze({
  name: "NotificationsIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "notifications action", code: "<NotificationsIcon decorative={false} label=\"notifications\" />" }],
