...
export default Object.freeze({
  name: "ChevronDownIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "chevronDown action", code: "<ChevronDownIcon decorative={false} label=\"chevronDown\" />" }],
