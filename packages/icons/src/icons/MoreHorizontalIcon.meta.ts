...
export default Object.freeze({
  name: "MoreHorizontalIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "moreHorizontal action", code: "<MoreHorizontalIcon decorative={false} label=\"moreHorizontal\" />" }],
