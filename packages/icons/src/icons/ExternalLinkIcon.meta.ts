...
export default Object.freeze({
  name: "ExternalLinkIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "externalLink action", code: "<ExternalLinkIcon decorative={false} label=\"externalLink\" />" }],
