...
export default Object.freeze({
  name: "MoreVerticalIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "moreVertical action", code: "<MoreVerticalIcon decorative={false} label=\"moreVertical\" />" }],
