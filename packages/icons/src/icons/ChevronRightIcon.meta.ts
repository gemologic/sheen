...
export default Object.freeze({
  name: "ChevronRightIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "chevronRight action", code: "<ChevronRightIcon decorative={false} label=\"chevronRight\" />" }],
