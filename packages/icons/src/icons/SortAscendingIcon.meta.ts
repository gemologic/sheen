...
export default Object.freeze({
  name: "SortAscendingIcon", package: "@gemologic/sheen-icons", category: "icons",
  ...
  examples: [{ title: "sortAscending action", code: "<SortAscendingIcon decorative={false} label=\"sortAscending\" />" }],
