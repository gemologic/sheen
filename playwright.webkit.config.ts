...
export default defineConfig({
  ...
  projects: [{
    ...
    testMatch: [
      ...
      "**/admin-app.spec.ts",
      "**/admin-capacity.spec.ts",
      "**/admin-collection.spec.ts",
      "**/admin-copy.spec.ts",
      "**/admin-numeric-formats.spec.ts",
      "**/admin-overview-layout.spec.ts",
      "**/admin-policies.spec.ts",
      "**/admin-states.spec.ts",
      "**/admin-style-flows.spec.ts",
      "**/admin-touch.spec.ts",
      "**/admin-zoom.spec.ts",
      "**/constrained-columns.spec.ts",
      "**/stat-visual.spec.ts",
      "**/studio-contrast.spec.ts",
      "**/studio-density.spec.ts",
      "**/studio-fonts.spec.ts",
      "**/studio-localization.spec.ts",
      "**/studio-motion.spec.ts",
      "**/studio-table-interactions.spec.ts",
